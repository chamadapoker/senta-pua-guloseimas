            ...
            {stats.devedores.map((d) => (
              <div key={d.cliente_id} className="flex items-center justify-between py-3 px-3 rounded-lg hover:bg-fundo transition-colors border-b border-borda last:border-0">
                ...
                <a href={montarLinkCobranca(d.nome_guerra, d.total_devido, d.whatsapp || undefined)} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 rounded-xl px-2.5 py-1 text-xs font-medium bg-green-50 text-verde-escuro border border-green-200 hover:bg-green-100">
