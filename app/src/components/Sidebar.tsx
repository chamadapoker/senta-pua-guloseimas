...
const IconClipboard = () => <I d="M9 12h6m-6 4h6m2.25-16.5h-13.5a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V6.75A2.25 2.25 0 0 0 18.75 4.5ZM12 6.75a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" />;
const IconHistory = () => (
  <I>
...
const IconVault = () => <I d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />;
const IconUsers = () => <I d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-3.833-6.247 4.125 4.125 0 0 0-3.833 6.247ZM15 19.128l-.75-1.368a6.75 6.75 0 0 1 3.933-6.508 6.75 6.75 0 0 1 3.933 6.508l-.75 1.368Zm-3 1.122a6.75 6.75 0 0 1-6.75-6.75 6.75 6.75 0 0 1 6.75-6.75 6.75 6.75 0 0 1 6.75 6.75 6.75 6.75 0 0 1-6.75 6.75Zm0-13.5a3.375 3.375 0 1 1 0 6.75 3.375 3.375 0 0 1 0-6.75Z" />;
...
const ADMIN_NAV: NavItem[] = [
  ...
  { to: '/admin/financeiro', label: 'Financeiro', icon: <IconBanknotes />, children: [
  ...
  { to: '/admin/pessoas', label: 'Pessoas', icon: <IconUsers />, children: [
